...
public class LocalTimeBaseStringComparater implements Predicate<String> {
	...
	public boolean test(String value) {
		...
		boolean result = type.compare(LocalTime.now(zoneId).minus(interval, unit), targetTime);
	...
	public enum Type {
		AFTER((v1, v2) -> v1.isAfter(v2)), BEFORE((v1, v2) -> v1.isBefore(v2)), EQUALS((v1, v2) -> v1.equals(v2));
